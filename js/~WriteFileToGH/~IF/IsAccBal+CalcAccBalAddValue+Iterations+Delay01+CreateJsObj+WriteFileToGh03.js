...
let datetime2 = datetime1+2000;//DELAY
...
/*
let datetime1 = new Date().getTime();
let datetime2 = datetime1+500;//DELAY
while(datetime1<datetime2) {datetime1 = new Date().getTime();}
*/
...
//console.log('xa,i,il,jl:',values [i][0],i,values.length,values[i].length);

//console.log('i Length:',values.length);
//console.log('j Length:',values[i].length);


//console.log(values [i][0],i,values.length,values[i].length);
//console.log(values [i][0],i);
...
//let content = isaccsonBal;
//let content = outputData;
//console.log('IsAccsOnBal/Content:',{content});
/*
