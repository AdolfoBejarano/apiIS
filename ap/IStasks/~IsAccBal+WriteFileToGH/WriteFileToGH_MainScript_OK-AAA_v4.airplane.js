...
(
{
  slug: "isaccson_accbalfetch_writefiletogh_v4",
  name: "isaccson_accbalfetch_writefiletogh_v4",
...
isacc = values [i][0];
let shared = require('./WriteFileToGH_SecondScript_OK-AAA_v4.js');
console.log('StartFucntOutput:',i,shared.writefiletoGH());
}
)
