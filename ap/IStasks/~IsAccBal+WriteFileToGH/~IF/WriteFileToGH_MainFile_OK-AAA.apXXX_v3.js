...
(
{
  slug: "isaccson_accbalfetch_writefiletogh_v3",
  name: "isaccson_accbalfetch_writefiletogh_v3",
...
let shared = require('./WriteFileToGH_SecondFile_OK-AAA.js');
console.log('b:',i,shared.b());
}
)
