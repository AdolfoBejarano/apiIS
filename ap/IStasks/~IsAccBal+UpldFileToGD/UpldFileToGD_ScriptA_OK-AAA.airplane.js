...
(
{
  slug: "isaccson_accbalfetch_upldfiletogd_v1",
  name: "isaccson_accbalfetch_upldfiletogd_v1",
...
fpathA = filePath;
fnameA = FileName;
let sharedB = require('./UpldFileToGD_ScriptB_OK-AAA.js');
console.log('FinalOutcomeB:',sharedB.writefiletoPC());
