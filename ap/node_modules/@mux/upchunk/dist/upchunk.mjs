...
var UpChunk = class {
  ...
  constructor(options) {
    ...
    this.chunkedStreamIterable = new ChunkedStreamIterable(this.file.stream(), { ...options, defaultChunkSize: options.chunkSize });
  ...
  get maxChunkSize() {
    var _a, _b;
    return (_b = (_a = this.chunkedStreamIterable) == null ? void 0 : _a.maxChunkSize) != null ? _b : DEFAULT_MAX_CHUNK_SIZE;
  }
  get minChunkSize() {
    var _a, _b;
    return (_b = (_a = this.chunkedStreamIterable) == null ? void 0 : _a.minChunkSize) != null ? _b : DEFAULT_MIN_CHUNK_SIZE;
  }
  get chunkSize() {
    var _a, _b;
    return (_b = (_a = this.chunkedStreamIterable) == null ? void 0 : _a.chunkSize) != null ? _b : DEFAULT_CHUNK_SIZE;
  }
  set chunkSize(value) {
  ...
  once(eventName, fn) {
    this.eventTarget.addEventListener(eventName, fn, { once: true });
  }
  off(eventName, fn) {
  ...
  async sendChunkWithRetries(chunk) {
    ...
    const retriableChunkUploadCb = async (_res, _chunk) => {
