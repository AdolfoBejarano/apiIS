import { CSSObject, MantineSize, Styles, TextInputStylesNames } from "@mantine/core";
...
export type TextInputComponentProps = TextInputComponentPropsBase & Omit<JSX.IntrinsicElements["input"], keyof TextInputComponentPropsBase | "ref">;
...
} & InputProps<TextInputTValue, ChangeEvent<HTMLInputElement>> & Omit<TextInputComponentProps, "defaultValue" | "defaultDisabled" | "id" | "styles">;
