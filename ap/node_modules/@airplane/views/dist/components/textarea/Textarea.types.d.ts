import { CSSObject, MantineSize, TextareaProps as MantineTextareaProps } from "@mantine/core";
...
export type TextareaComponentProps = TextareaComponentPropsBase & Omit<JSX.IntrinsicElements["textarea"], keyof TextareaComponentPropsBase | "ref">;
...
} & InputProps<TextInputTValue, ChangeEvent<HTMLTextAreaElement>> & Omit<TextareaComponentProps, "defaultValue" | "defaultDisabled" | "id">;
