import { MantineSize, CSSObject, SelectProps as MantineSelectProps } from "@mantine/core";
...
export type ConnectedSelectProps = {
    ...
    task?: never;
} & InputProps<SelectTValue, SelectTValue> & Omit<SelectComponentProps, "onChange">;
export type SelectPropsWithTask<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = {
    /**
    ...
    onChange?: (value: SelectTValue) => void;
    data?: never;
} & InputProps<SelectTValue, SelectTValue> & Omit<SelectComponentProps, "data" | "onChange">;
export type SelectProps<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = SelectPropsWithTask<TParams, TOutput> | ConnectedSelectProps;
export {};
