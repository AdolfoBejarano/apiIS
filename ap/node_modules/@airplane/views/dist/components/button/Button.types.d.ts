...
export type ButtonComponentLinkProps = ButtonComponentLinkPropsBase & Omit<JSX.IntrinsicElements["a"], keyof ButtonComponentLinkPropsBase | "ref" | "onClick">;
...
export type ButtonComponentButtonProps = ButtonComponentButtonPropsBase & Omit<JSX.IntrinsicElements["button"], keyof ButtonComponentButtonPropsBase | "href" | "ref">;
...
export type ButtonComponentProps = ButtonComponentLinkProps | ButtonComponentButtonProps;
export type ButtonPropsWithTask<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = {
    /**
...
export type ButtonPropsWithRunbook<TParams extends ParamValues | undefined = DefaultParams> = {
    /**
...
export type ButtonProps<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = (ButtonComponentProps & {
    task?: never;
    runbook?: never;
}) | ButtonPropsWithTask<TParams, TOutput> | ButtonPropsWithRunbook<TParams>;
