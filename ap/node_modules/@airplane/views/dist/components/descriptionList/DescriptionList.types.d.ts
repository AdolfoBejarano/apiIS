...
export type DescriptionListPropsWithTask<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = {
    /**
     ...
     */
    outputTransform?: (output: TOutput) => DescriptionListComponentProps["items"] | Record<string, React.ReactNode>;
    items?: never;
} & Omit<DescriptionListComponentProps, "items">;
export type DescriptionListProps<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = DescriptionListPropsWithTask<TParams, TOutput> | DescriptionListComponentProps;
