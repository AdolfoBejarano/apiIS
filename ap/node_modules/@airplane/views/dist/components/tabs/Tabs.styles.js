...
const useStyles = createStyles((theme, params) => {
  return {
    ...
    tabsList: {
      borderBottom: params.placement == "top" ? theme.other.borderStyles.light : "none",
      borderTop: params.placement == "bottom" ? theme.other.borderStyles.light : "none",
      borderRight: params.placement == "left" ? theme.other.borderStyles.light : "none",
      borderLeft: params.placement == "right" ? theme.other.borderStyles.light : "none"
    }
  };
});
export {
