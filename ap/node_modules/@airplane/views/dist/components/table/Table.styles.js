...
import { getEditIconStyle } from "./getEditIconStyle.js";
  ...
  return {
    ...
    tableContainer: {
      ...
      ".table": {
        overflow: "auto",
        ...theme.fn.fontStyles(),
        fontSize: theme.other.typography.textPreset["sm"].fontSize,
        // NOTE: This seems to be a catch all, I'm not sure if it does anything but matching to be new body size for the table (14px). We can remove this if it's not needed (and maybe even the line above — not sure what that does).
        display: "block",
        borderSpacing: 0,
        ".tr": {
    ...
    actionContainer: {
      ...
      // calc of -1px is a temporary fix since the rowAction button is 26px tall (as opposed to 24px)
      "> *:not(:last-child)": {
    ...
    tableActions: {
      ...
      minHeight: "32px"
      // Standardizes the height of the action bar area such that it doesn't shift if no filter is present
    },
    tableFooter: {
      background: headerBgColor,
      display: "flex",
    ...
    cellEditIcon: {
      ".cellEditIcon": {
        ...
        marginTop: "8px"
        // To align the edit icon with the text
      }
    },
