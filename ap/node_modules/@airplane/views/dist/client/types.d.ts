...
export type Parameter = {
    slug: string;
    name: string;
    type: "boolean" | "upload" | "date" | "datetime" | "float" | "integer" | "string" | "json";
 ...
 */
export declare const isConstraintOptions: (options: unknown) => options is ConstraintOption[];
/**
 * isConstraintOption is a user-defined type guard for checking if a variable is a constraint option.
 */
export declare const isConstraintOption: (o: unknown) => o is ConstraintOption;
/**
 * isTaskOption is a user-defined type guard for checking if a variable is a TaskOption.
 */
export declare const isTaskOption: (options: unknown) => options is TaskOption;
export type JSONValue = string | number | boolean | null | JSONObject | JSONArray;
export interface JSONObject {
    [key: string]: JSONValue;
}
export type JSONArray = Array<JSONValue>;
export type SingleParamValue = string | boolean | number | Template | ConfigVar | ParamList | ParamMap | JSONValue | undefined | null;
...
export declare const isTemplate: (v: unknown) => v is Template;
