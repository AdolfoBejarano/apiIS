...
import { ExecuteError, TaskMutation, RefetchQuery } from "../../components/query";
export type MutationHookOptions<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = {
    /**
...
export type MutationFn<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = (options?: MutationHookOptions<TParams, TOutput>) => void;
...
export type MutationResult<TParams extends ParamValues | undefined = DefaultParams, TOutput = DefaultOutput> = {
    /**
 ...
 */
export declare const useTaskMutation: <TParams extends ParamValues | undefined = DefaultParams, TOutput = any>(mutation: TaskMutation<TParams, TOutput>) => MutationResult<TParams, TOutput>;
