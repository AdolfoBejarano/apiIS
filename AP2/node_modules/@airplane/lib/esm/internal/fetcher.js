...
import { setTimeoutWithCancel } from "./set_timeout";
...
export class Fetcher {
    ...
    async request(path, method, opts = {}) {
        ...
        const idempotencyKey = opts.idempotencyKey || ((_e = opts.headers) === null || _e === void 0 ? void 0 : _e["Idempotency-Key"]) || uuidv4();
        ...
        return fetchWithRetries({
            ...
            retryDelay: (_g = this.opts.retryDelay) !== null && _g !== void 0 ? _g : defaultRetryDelay,
            mode: this.opts.mode,
...
const fetchWithRetries = async (req) => {
    ...
    while (true) {
        ...
        if (attempt > 1) {
            ...
            await setTimeoutWithCancel(durationMs, controller);
        ...
        try {
            ...
            if ((err instanceof TypeError || (isFetchError(err) && err.code === "ECONNREFUSED")) &&
                ...
                throw new HTTPError("Request failed due to network issue.", {
                    method: req.method,
                    url: req.url,
                    statusCode: 500,
 ...
 */
export const defaultRetryDelay = (attempt) => {
    const baseMs = 200;
    const capMs = 30000;
