...
exports.func = exports.ChatBot = exports.chat = exports.setLogging = void 0;
...
const func = (instructions, examples, opts) => {
...
const anthropicChat = async (messages, opts) => {
    var _a, _b, _c;
    const client = new sdk_1.Client((_a = process.env.ANTHROPIC_API_KEY) !== null && _a !== void 0 ? _a : "");
    ...
    anthropicMessages.push(sdk_1.AI_PROMPT);
