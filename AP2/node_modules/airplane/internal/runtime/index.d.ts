...
import { CreatePromptRequest, CreateUploadResponse, DisplayConfig, ExecuteBackgroundResponse, Prompt, Run, Session, User } from "../api/types";
...
export type RuntimeInterface = {
    ...
    executeBackgroundWithCacheInfo(slug: string, paramValues: SerializedParamValues, resources?: Record<string, string> | undefined | null, opts?: ClientOptions): Promise<ExecuteBackgroundResponse>;
