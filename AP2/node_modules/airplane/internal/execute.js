...
exports.executeRunbookBackground = exports.executeRunbook = exports.executeWithResourcesBackgroundWithCacheInfo = exports.executeWithResourcesBackground = exports.executeWithResources = exports.executeBackgroundWithCacheInfo = exports.executeBackground = exports.execute = void 0;
...
const executeBackgroundWithCacheInfo = async (slug, paramValues = {}, opts = {}) => {
    return (0, exports.executeWithResourcesBackgroundWithCacheInfo)(slug, paramValues, {}, opts);
};
exports.executeBackgroundWithCacheInfo = executeBackgroundWithCacheInfo;
...
const executeWithResourcesBackgroundWithCacheInfo = async (slug, paramValues = {}, resources, opts = {}) => {
    return (0, runtime_1.getRuntime)().executeBackgroundWithCacheInfo(slug, (0, params_serialized_1.serializeParamValues)(paramValues), resources, opts);
};
exports.executeWithResourcesBackgroundWithCacheInfo = executeWithResourcesBackgroundWithCacheInfo;
